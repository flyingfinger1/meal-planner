            ...
            <div className="p-4 space-y-3">
              ...
              {isOwner ? (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Kalender-Filter</label>
                    <input
                      type="text"
                      value={icalLabel}
                      onChange={e => setIcalLabel(e.target.value)}
                      placeholder="z.B. Besuch"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-400 mt-1">
                      Nur Ereignisse anzeigen, die diesen Text im Titel enthalten. Leer lassen für alle.
                    </p>
                  </div>
                  <button
                ...
                <div>
                  <p className="text-xs text-gray-500 mb-1">Kalender-Filter</p>
                  <p className="text-sm text-gray-800">
                    {icalLabel || <span className="text-gray-400 italic">Kein Filter aktiv</span>}
                  </p>
                </div>
              )}
            </div>
